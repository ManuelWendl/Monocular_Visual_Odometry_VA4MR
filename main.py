...
debug = False
num_frames_to_process = 100 # 2761 (Kitti) 
stride = 2 if ds == 1 else 3 if ds == 0 else 1  # Stride for frame processing
...
for i in range(bootstrap_frames[1] + 1, num_frames_to_process,stride): #first make it run for the first frames and extend later
    print(f'\n\nProcessing frame {i}\n=====================')
...
plot_camera_trajectory(positions_list, rotations_list,ground_truth,stride,show_rot=False)
